    ...
    <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 p-8 shadow-sm">
      ...
      <div className="mt-6">
        ...
        <a
          ...
          className="mt-4 flex items-center justify-center gap-3 w-full rounded-lg border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 py-2 text-sm font-medium hover:bg-slate-50 dark:hover:bg-slate-700 transition"
        >
